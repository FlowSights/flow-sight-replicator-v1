          ...
          <Card className="border-gray-100 dark:border-white/5 shadow-2xl rounded-[32px] backdrop-blur-3xl bg-white/80 dark:bg-white/[0.02] p-8 overflow-hidden">
            ...
            {isLogin ? (
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                <Button type="button" variant="outline" className="w-full py-7 rounded-2xl border-gray-100 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 flex items-center justify-center gap-3 font-bold" onClick={handleLoginWithGoogle}>
