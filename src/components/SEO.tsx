...
const SEO = ({ 
  ...
  const fullTitle = title ? `${title} | ${siteName}` : `FlowSights | Software de Inteligencia Operativa y Datos para PyMEs`;
  const defaultDescription = "En FlowSights somos expertos en Inteligencia Operativa y Limpieza de Datos para PyMEs. Transformamos tu Excel, POS y WhatsApp en decisiones que generan dinero.";
